...
var or__21706__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__21706__auto__)){
return or__21706__auto__;
} else {
var or__21706__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__21706__auto____$1)){
return or__21706__auto____$1;
} else {
var or__21706__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__21706__auto____$2)){
return or__21706__auto____$2;
} else {
var or__21706__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__21706__auto____$3)){
return or__21706__auto____$3;
} else {
...
var n__22621__auto__ = a.length;
var i = (0);
while(true){
if((i < n__22621__auto__)){
var c_23144 = (a[i]);
if(cljs.core.truth_((c_23144["cljsIsDirty"]))){
(c_23144["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__22312__auto__,writer__22313__auto__,opt__22314__auto__){
return cljs.core._write.call(null,writer__22313__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__23148 = c;
var G__23148__$1 = (((G__23148 == null))?null:(G__23148["props"]));
if((G__23148__$1 == null)){
return null;
} else {
return (G__23148__$1["argv"]);
}
});
...
var G__23150_23151 = (c["cljsRatom"]);
if((G__23150_23151 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__23150_23151);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1467154999502