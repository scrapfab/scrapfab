...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22312__auto__,writer__22313__auto__,opt__22314__auto__){
return cljs.core._write.call(null,writer__22313__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__21706__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__21706__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__21706__auto__)){
return or__21706__auto__;
} else {
...
var G__23259 = o;
(G__23259[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__23260__delegate = function (args){
...
while (G__23261__i < G__23261__a.length) {G__23261__a[G__23261__i] = arguments[G__23261__i + 0]; ++G__23261__i;}
  args = new cljs.core.IndexedSeq(G__23261__a,0);
} 
return G__23260__delegate.call(this,args);};
G__23260.cljs$lang$maxFixedArity = 0;
G__23260.cljs$lang$applyTo = (function (arglist__23262){
var args = cljs.core.seq(arglist__23262);
return G__23260__delegate(args);
});
...
var old_23263 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_23263))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_23263)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__21694__auto__ = (node === document.activeElement);
if(and__21694__auto__){
var and__21694__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__21694__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__23266 = jsprops;
(G__23266["defaultValue"] = value);

(G__23266["onChange"] = ((function (G__23266,v,value,on_change){
return (function (p1__23264_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23264_SHARP_);
});})(G__23266,v,value,on_change))
);
...
var vec__23268 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23268,(0),null);
...
var temp__4659__auto__ = (function (){var G__23272 = cljs.core.meta.call(null,v);
if((G__23272 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__23272);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__23274_23275 = v;
var G__23274_23276__$1 = (((G__23274_23275 == null))?null:reagent.impl.template.key_from_vec.call(null,G__23274_23275));
if((G__23274_23276__$1 == null)){
} else {
(jsprops["key"] = G__23274_23276__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__23279 = cljs.core.meta.call(null,argv);
if((G__23279 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__23279);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__23280 = (((jsprops == null))?{}:jsprops);
(G__23280["key"] = key);
...
var G__23281 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23281;
continue;
}
} else {
...
var n__22621__auto___23282 = a.length;
var i_23283 = (0);
while(true){
if((i_23283 < n__22621__auto___23282)){
(a[i_23283] = reagent.impl.template.as_element.call(null,(a[i_23283])));

var G__23284 = (i_23283 + (1));
i_23283 = G__23284;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__22621__auto___23285 = a.length;
var i_23286 = (0);
while(true){
if((i_23286 < n__22621__auto___23285)){
var val_23287 = (a[i_23286]);
if((cljs.core.vector_QMARK_.call(null,val_23287)) && ((reagent.impl.template.key_from_vec.call(null,val_23287) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23286] = reagent.impl.template.as_element.call(null,val_23287));

var G__23288 = (i_23286 + (1));
i_23286 = G__23288;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__21694__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__21694__auto__){
return (ctx["no-key"]);
} else {
return and__21694__auto__;
...
var G__23290 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23290) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23290){
...
//# sourceMappingURL=template.js.map?rel=1467155001181